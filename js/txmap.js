...
$.ajax({
    ...
    data: {
        key: 'FQQBZ-Q45WU-IYJV4-GNN3S-QQEFZ-XSBN6',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.956920, 30.918746, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
